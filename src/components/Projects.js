...
const Projects = () => {
  return (
    ...
    {ProjectsData.map((proj)=>{
      return(
        <div className=" mb-3 p-4 group hover:drop-shadow-md hover:bg-slate-800/50 rounded-lg">
                  <div className=" lg:mt-2 sm:mt-4 lg:flex-row sm:flex-col  sm:p-1 flex ">
      <div className="lg:mr-6 lg:w-1/3 sm:w-2/3 sm:pr-2 sm:ml-0 ml-3">
        <img alt="portfolio" src={proj.imgsrc} className="w-40 h-20 border-2 border-white"></img>
