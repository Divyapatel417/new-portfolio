...
export const ExperienceData = [
  ...
  },
  {
    ...
    skills: ["python", "Data Modeling", "Applied Mathematics"],
  },
];
export const AboutData = [
  'Welcome to my portfolio website! I am Divya patel, a passionate <span class="font-semibold text-brighttext">front-end developer</span> with a deep love for crafting engaging and user-friendly web experiences. My journey into the world of web development began during my Masters in Information technology at  <span class="font-semibold text-brighttext">Flinders university</span>, where I honed my skills in  <span class="font-semibold text-brighttext">HTML, CSS, and JavaScript</span>. This academic foundation provided the springboard for my career, propelling me into the exciting realm of React development.',
  'My experience as a React front-end developer has allowed me to work on dynamic web applications, harnessing the power of technologies like  <span class="font-semibold text-brighttext">React, Redux, and Git</span> to create seamless and visually appealing user interfaces. Beyond my professional role, I have also ventured into the world of freelance web development, where I have had the privilege of collaborating with a client to bring their digital visions to life. With a strong commitment to delivering excellence in every project, I am excited to showcase my work and share my passion for web development with you.',
];
